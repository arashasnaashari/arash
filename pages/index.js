export default function Home() {
  return (
    <div className="container">
      <h1 className="name3">Hello im Arash Esnaashari</h1>
      <div className="vscode">
        <p><span style={{color:"#569cd6"}}>function</span> <span style={{color:"green"}}>Man</span>() {'{'} </p>
          ...
          <p className="bist"><span style={{color:"#569cd6"}}>this</span>.<span style={{color:"#DCDCAA"}}>as_a_Devops</span> = <span style={{color:"#569cd6"}}>function</span> () {'{'}</p>
            <p className="chel"><span style={{color:"#9CDCFE"}}>console</span>.<span style={{color:"#DCDCAA"}}>log</span>(<span style={{color:"#ce9178"}}>"deploy and grow webapp"</span>) </p>
          <p className="bist">{'};'}</p>
          <p className="bist"><span style={{color:"#569cd6"}}>this</span>.<span style={{color:"#DCDCAA"}}>as_a_BackendDev</span> = <span style={{color:"#569cd6"}}>function</span> () {'{'}</p>
            <p className="chel"><span style={{color:"#9CDCFE"}}>console</span>.<span style={{color:"#DCDCAA"}}>log</span>(<span style={{color:"#ce9178"}}>"develop fast and scalable webapp"</span>)</p>
          <p className="bist">{';'}</p>
          <p className="bist"><span style={{color:"#569cd6"}}>this</span>.<span style={{color:"#DCDCAA"}}>as_a_FrontendDev</span> = <span style={{color:"#569cd6"}}>function</span> () {'{'}</p>
            <p className="chel"><span style={{color:"#9CDCFE"}}>console</span>.<span style={{color:"#DCDCAA"}}>log</span>(<span style={{color:"#ce9178"}}>"design cool & multy platform webapp "</span>)</p>
          <p className="bist">{'};'}</p>
        <p>{'};'}</p>
      </div>
